...
unsigned int temp;
int snum;		//used for accessing the numbers in all programs
int dnum;		//used for accessing the numbers in all programs 
int pos;		//used in all the programs for accessing the position in a num
int op;			//used to select the functions in some programs
int num;		//used for accessing number
int s;			//used for source position
int d;			//used for destination position
int n;			//used for accessing no. of bits
int i;			//used in loops
int j;			//used in loops 
int l;			//used for holding particular bit in a number
int m;			//used for holding particular bit in a number 
int a;
int b;			//used for counting the bits
int c;
int c1;    //used for counting the 1's in finding max number in given 2 numbers
int c2;    //used for counting the 1's in finding max number in given 2 numbers
int x;
int y;                                                                      
int p;                                                                      
...
int main (void)
{
    ...
    if (NULL == (number = (char *) malloc (sizeof(char) * MAX))){
	...
	do{
		...
		printf ("enter choice for a program & 0 for exit : \n ");
		...
		case 1 : /*experiment 1 : Given 2 bit positions d and s in a number n,
                ...
                do{                                                             
                     if (NULL == (fgets(number, MAX, stdin))){                  
                             perror ("fgets failed.. \n");                      
                             exit (1);                                          
                     }                                                          
                    n = int_valid(number);                                      
...
//				scanf ("%d", &dnum);
		...
		case 4 :
				//experiment 4 : even and odd bit toggle implementations
				printf ("I am considering source position from msb \n");
		...
		case 6 :			
				/*experiment 6 : implementing functionsfor right rotate,
								 left rotate,left rotate for n bits and 
		...
		case 7 :/*experiment 7 : functions which will count the number of
				 bits set and number of bits cleared in the given number 
				 respectively*/
				 printf ("I am considering source position from msb \n");
		...
		default :
				  printf ("enter correct optionto select program \n");
				  break;
		}
