...
int main (void)
{
	...
	do {
		...
		printf ("\nEnter the choice of program & 0 for exit: \n");
		
		printf ("1.strcpy 2.strncpy 3.first occurance of char in string \n");
		...
		printf ("12.sueze 13.strrot whether strings are rotated or not \n");
		...
		case 2 : //experiment 2 : strncpy which copies n characters 
				 ...
				 if (n <= my_strlen(sbuf))
					 ...
					 printf ("n is greater than string length of sbuf \n");
					 goto label1;
				 }
		...
		case 4 : /* experiment 4 : to append the dbuf string with sbuf string*/
		...
		case 7 : /*function int strcasecmp which compares two strings 
						str1 and str2 by ignoring the case (lower or upper)*/
		...
		case 9 : /*A function char * strtok which parses buf until it 
								encounters any of the delimiter in delim*/
		...
		case 12 ://To squeeze the consecutive similar characters in a string
				 printf ("enter the buffer string : \t");
		...
		case 15 : /*a function which will insert a char ch in the given string 
					str at a specified position pos*/
				 printf ("enter the main string : \t");
	...
	}while (choice != 0);	//untill user has to terminate by passing 0
